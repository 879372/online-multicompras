...
ROWS = [
    ...
    ('ASIS', 'Apple', 'iPhone 16', '', '256 GB', '', 'Seminovo Premium', 4050, ['White'], 6, 'AstroTech', True, '', None),
    ('ASIS', 'Apple', 'iPhone 16 Pro', '', '128 GB', '', 'Seminovo Premium', 4400, ['White'], 6, 'AstroTech', True, '', None),
    ('ASIS', 'Apple', 'iPhone 16 Pro', '', '256 GB', '', 'Seminovo Premium', 4700, ['White'], 6, 'AstroTech', True, '', None),
    ('ASIS', 'Apple', 'iPhone 16 Pro Max', '', '256 GB', '', 'Seminovo Premium', 5300, ['Desert', 'Black'], 6, 'AstroTech', True, '', None),
